    ...
    return (
        <div className="relative mt-15 flex justify-between items-center">
            <button
                onClick={onFirst}
                disabled={page <= 1}
                className="cursor-pointer bg-gray-300 disabled:opacity-40
            ...
            <div className="absolute left-1/2 -translate-x-1/2 flex">
                <button
                    onClick={onPrev}
                    disabled={page <= 1}
                    className="cursor-pointer bg-white border border-main-blue disabled:opacity-50 enabled:bg-main-blue/8
                ...
                <button
                    ...
                    className="cursor-pointer bg-main-blue text-white disabled:opacity-50
                    px-4 md:px-10 lg:px-20 
                    py-1 md:py-3 lg:py-4"
                >
                    다음

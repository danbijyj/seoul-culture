...
const Tabs = ({
    ...
    const baseOpacity = scrolled ? 'opacity-100' : 'opacity-0';
    ...
    const activeBtn =
        'bg-main-green border-white border-2 hover:bg-main-green/80';
    ...
    return (
        <div className="flex gap-2 lg:gap-5 font-bold text-white">
            <button
                ...
                className={`tab-btn ${baseOpacity} cursor-pointer flex flex-col items-center justify-center gap-1 lg:gap-3 ${btnSize} ${
